package com.jupiterinfologic.jupiterserver.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jupiterJhipMySQLServerApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jupiterJhipMySQLServerApplication");
        ...
        config.getMapConfigs().put("com.jupiterinfologic.jupiterserver.domain.*", initializeDomainMapConfig(jHipsterProperties));
